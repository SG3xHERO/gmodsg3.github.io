<?php
	...
	*/
	...
	$serverPort = '27015';
	$serverName = "Some Autstic Server";
	...
	$default_map = 'gm_mobenix_v3_final'; // Default map if you're viewing in browser
	$SteamAPIKey = '8B5E1D231125EC45C13FF968F0CB48C5'; // SteamAPI Key (http://steamcommunity.com/dev/apikey)
	$SteamWorkshopid = '1997254317'; // Steam Workshop Content ID (http://steamcommunity.com/sharedfiles/filedetails/?id=XXXXXXXXX)
